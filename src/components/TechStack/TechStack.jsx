...
const STACKS = [
  {
    ...
    chips: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'GSAP', 'WebGL', 'Three.js'],
  },
  {
    id: 'backend',
    num: '02',
    ...
    chips: ['Node.js', 'FastAPI', 'PostgreSQL', 'Redis', 'GraphQL', 'REST APIs', 'WebSockets', 'Microservices'],
  },
  {
    id: 'ai',
    num: '03',
    ...
    chips: ['LangGraph', 'Anthropic Claude', 'OpenAI GPT', 'RAG Pipelines', 'Vector DBs', 'Fine-tuning', 'LlamaIndex', 'Whisper'],
  },
  {
    id: 'cloud',
    num: '04',
