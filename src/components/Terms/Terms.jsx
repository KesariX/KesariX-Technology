      ...
      <div className="legal-body">
        ...
        <div className="legal-content">
          ...
          <section id="governing">
            ...
            <p>These Terms are governed by the laws of India. Any disputes arising under these Terms shall be subject to the exclusive jurisdiction of the courts in Gujarat, India.</p>
